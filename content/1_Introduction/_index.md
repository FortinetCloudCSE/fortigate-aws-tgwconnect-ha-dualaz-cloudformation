...
![Example Diagram](../fgcp-tgwc-1.png)

![Example Diagram](../fgcp-tgwc-2.png)

## Welcome

The purpose of this site is to provide a quick start guide for using Infrastructure as Code (IaC) templates located in the repo [**fortigate-aws-tgwconnect-ha-dualaz-cloudformation**](https://github.com/FortinetCloudCSE/fortigate-aws-tgwconnect-ha-dualaz-cloudformation).
